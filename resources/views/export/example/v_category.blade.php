...
<head>
    ...
    <title>Template Import Kategori Barang</title>
</head>
<body>
    <div class="table-responsive">
        <table class="table table-bordered border-primary">
            <thead class="thead-dark">
                ...
                <td style="text-align: center; font-size:10px">name_type</td>
    ...
    <div class="table-responsive">
        <table class="table table-bordered border-primary">
            <thead class="thead-dark">
                ...
                <td style="text-align: center; background-color:#7dd8ff; font-size:10px; color:red">ID Jenis *</td>
                <td style="text-align: center; background-color:#7dd8ff; font-size:10px;">Nama Jenis</td>
                <td style="text-align: center; background-color:#7dd8ff; font-size:10px; color:red">Nama Kategori *</td>
