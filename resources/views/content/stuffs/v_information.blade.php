                ...
                <div class="modal-content">
                    <form class="m-form m-form--fit m-form--label-align-right" id="formSubmit">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group display-stuff">
                                <label>Pengadaan</label>
                                <select name="id_procurement" id="id_procurement"
                            ...
                            <div class="row display-stuff">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly name="updated_date" id="m_datetimepicker_6"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
