                ...
                <div class="modal-content">
                    <form class="m-form m-form--fit m-form--label-align-right" id="formSubmit">
                        ...
                        <div class="modal-body">
                            <input type="hidden" name="id" id="id_source">
                            <div class="form-group">
                                <label>Kode</label>
                                <input type="text" required class="form-control m-input" id="code" name="code"
                                    placeholder="Kode">
                            </div>
                            <div class="form-group">
    ...
    @push('scripts')
        ...
        <script>
            ...
            function editData(id) {
                $.ajax({
                    url: "{{ route('source.detail') }}",
                    data: {
                        id
                    },
                    success: function(data) {
                        $('.modal-title').html("Edit {{ session('title') }}");
                        $('#id_source').val(data.id);
                        $('#code').val(data.code);
                        $('#name').val(data.name);
                        $('#modalForm').modal('show');
                    }
