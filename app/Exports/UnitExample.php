...
class UnitExample implements FromView, ShouldAutoSize, WithStyles, WithColumnWidths
{
    public function view(): View
    {
        return view('export.example.v_unit');
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->mergeCells('A5:K5')->setCellValue('A5', "3. Kolom nama satuan wajib diisi.");
