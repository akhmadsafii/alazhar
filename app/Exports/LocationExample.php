...
class LocationExample implements FromView, ShouldAutoSize, WithStyles, WithColumnWidths
{
    public function view(): View
    {
        return view('export.example.v_location');
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->mergeCells('A5:K5')->setCellValue('A5', "3. Kolom nama lokasi wajib diisi.");
        ...
        // style cells
        $sheet->getStyle('A7:A50')->applyFromArray([
            'borders' => [
                'allBorders' => [
